...
data.applications = [
        ...
        ]}, 
    {
        ...
        [
            ...
            id: 16,
            name: 'Sneaktory',
            description: "Inventory tracking system for StockX",
        ...
        data.media = [
            ...
            { 
                ...
                shoes: [
                    ...
                    type: 'Marketing',
                    description: ['Managed social media for record label, creating promotional campaigns for artist releases garnering tens of thousands of views.', 'Work was featured across various publications including Complex.'],
                    team: true,
